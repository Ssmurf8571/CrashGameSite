...
$(document).ready(function() {
    $('head').append('<link rel="stylesheet" href="../libs/games/slots/styles.css">');
});
...
(function($){
    ...
    // var credits = $.ajax({
    //     url : '../libs/games/slots/balance.php',
    //     success : function(data) {
    //         credits = data;
    //     }
    // });

    var credits = document.getElementById('slot-credits').innerHTML;
    // console.log(credits);
